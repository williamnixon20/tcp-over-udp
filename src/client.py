...
class Client:
    ...
    def initiate_handshake(self):
        ...
        print("[!] [Handshake] Sending broadcast SYN request to port",
              self.broadcast_port)
        ...
        while True:
            try:
                ...
                if received_segment.is_fin():
                    print("[Segment SEQ={}] Received FIN. Acking and closing connection.".format(
                    ...
                    print("[Segment SEQ={}] Received, Ack sent".format(
                        received_segment.sequence_number))
                ...
                print(e)
                print("[!] Retrying...")
                print("[Segment SEQ={}] Something went wrong.. Ack previous sequence number.".format(
